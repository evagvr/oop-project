...
void InputHandler::verificaStringInput(const std::vector<std::string>& validOptions) const {
    std::string input;
    while (true) {
...
std::string InputHandler::getStringInput(const std::vector<std::string>& validOptions) const {
    std::string input;
    while (true) {
        std::getline(std::cin, input);
...
int InputHandler::getIntInput(int min, int max) const {
    while (true) {
        std::string line;
